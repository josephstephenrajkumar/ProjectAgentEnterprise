"""
Starter migration loader for ProjectAgentEnterprise Option 1 refactor.

Place under:
backend/app/services/migration_loader.py
"""
...
def migrate_project_baseline(conn: sqlite3.Connection, project_id: str) -> str:
    ...
    total_hours = json.loads(project["total_hours_json"] or "{}")
